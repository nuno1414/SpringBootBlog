package me.eskim.springbootdeveloper.config.jwt;
...
public class TokenProvider {
    ...
    private String makeToken(Date expiry, User user) {
        ...
        return Jwts.builder()
                ...
                // 내용 iss : merpadan1@gmail.com(propertise 파일에서 설정한 값)
                .setIssuer(jwtProperties.getIssuer())
                .setIssuedAt(now) // 내용 iat : 현재시간
                .setExpiration(expiry) // 내용 exp : expiry 멤버 변수 값
                .setSubject(user.getEmail()) // 내용 : 유저의 이메일
                .claim("id", user.getId()) // 클라임 id : 유저 ID
